...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        $isWarning
            ...
            : $this->success('Product updated with success.', redirectTo: '/products/' . $this->product->id . '/edit');
    }
}; ?>

<div>
    <x-header title="Update {{ $product->name }}" separator />
    <div class="grid gap-5 lg:grid-cols-2">
        <div class="">
            <x-form wire:submit="save">
                <x-file label="Image" wire:model="photo" accept="image/png, image/jpeg" crop-after-change>
                    <img src="{{ $product->url ?? '/empty-user.jpg' }}" class="h-40 rounded-lg" />
                </x-file>
